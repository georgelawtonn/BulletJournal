...
/**
 * The controller for the edit category popup in the Bujo program, responsible for handling category
 * editing functionality.
 */
public class EditCategoryPopupController extends Apopup {
  ...
  /**
   * Constructs an EditCategoryPopupController object with the specified stage and BujoController.
   *
   * @param stage          the stage where the popups will appear
   * @param bujoController the BujoController instance for managing category editing
   */
  public EditCategoryPopupController(Stage stage, BujoController bujoController) {
    super(stage);
  ...
  protected void hidePopup(Popup popup) {
    confirm.setOnAction(e -> {
      ...
      bujoController.addCategory(newCategory); // @TODO Verify This Works
      bujoController.editEntry(name, dayOfWeek, type, newCategory, 3);
    });
  }
}
