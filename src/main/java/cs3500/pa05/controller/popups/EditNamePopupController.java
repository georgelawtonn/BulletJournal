...
/**
 * The controller for the edit name popup in the Bujo program, responsible for handling name
 * editing functionality.
 */
public class EditNamePopupController extends Apopup {
   ...
   */
  public EditNamePopupController(Stage stage, BujoController bujoController) {
    super(stage);
  ...
  protected void hidePopup(Popup popup) {
    confirm.setOnAction(e -> {
      ...
      bujoController.editEntry(name, dayOfWeek, type, newName, 1);
    });
  }
}
